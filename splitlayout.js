...
(function() {
	...
	/*	if( mobilecheck() ) {
		...
		leftSide.querySelector( 'button.products_button' ).addEventListener( eventtype, function( ev ) {
			reset();
			classie.add( splitlayout, 'open-left' );
		} );

		rightSide.querySelector( 'button.products_button' ).addEventListener( eventtype, function( ev ) {
			reset();
		...
		splitlayout.querySelector( 'p.back-left' ).addEventListener( eventtype, function( ev ) {
			reset();
			classie.remove( splitlayout, 'open-left' );
		} ); 
		splitlayout.querySelector( 'p.back-right' ).addEventListener( eventtype, function( ev ) {
			reset();
			classie.remove( splitlayout, 'open-right' );
		} );
	}
